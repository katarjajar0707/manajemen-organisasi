...
export function PengaturanAdmin({ initialSettings, initialStats, initialLogs = [], userRole = 'admin' }: PengaturanAdminProps) {
  ...
  const handleLogoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!isImageFile(file)) {
      triggerToast('File logo harus berupa gambar.', 'warning');
      return;
    }
    ...
    <div className="space-y-6 max-w-5xl">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-amber-200/90 text-[11px] mt-0.5">
                Tabel <code className="font-mono bg-amber-500/20 px-1 py-0.5 rounded">pengaturan_sistem</code> belum ada di database. Silakan jalankan script <code className="font-mono font-bold">010_phase11_pengaturan_sistem.sql</code> di
                Supabase SQL Editor.
              </p>
            </div>
          </div>
          <Button size="sm" variant="outline" onClick={copyMigrationNote} className="h-7 text-xs gap-1.5 border-amber-500/40 text-amber-300 hover:bg-amber-500/20 shrink-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/60 pb-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Kelola konfigurasi profil organisasi, parameter operasional, kebijakan akses, dan data backup platform.</p>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input id="nama-periode" value={operasional.periodeAktif} onChange={(e) => setOperasional({ ...operasional, periodeAktif: e.target.value })} />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="tgl-mulai" className="text-xs">
                      Tanggal Pelantikan / Mulai
                    </Label>
                    <Input id="tgl-mulai" type="date" value={operasional.tglMulaiPeriode} onChange={(e) => setOperasional({ ...operasional, tglMulaiPeriode: e.target.value })} />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="tgl-selesai" className="text-xs">
                      Estimasi Selesai Masa Bakti
                    </Label>
                    <Input id="tgl-selesai" type="date" value={operasional.tglSelesaiPeriode} onChange={(e) => setOperasional({ ...operasional, tglSelesaiPeriode: e.target.value })} />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="space-y-1.5 max-w-md">
                  ...
                  <Input id="format-surat" value={operasional.formatNomorSurat} onChange={(e) => setOperasional({ ...operasional, formatNomorSurat: e.target.value })} />
                  <p className="text-[11px] text-muted-foreground">
                    Variabel yang tersedia: <code className="text-primary font-mono">&#123;NOMOR&#125;</code> (3 digit otomatis), <code className="text-primary font-mono">&#123;BULAN&#125;</code> (Romawi),{' '}
              ...
              <CardContent className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      <Input id="max-hari-pinjam" type="number" min="1" max="30" className="w-28" value={operasional.maxHariPinjamInventaris} onChange={(e) => setOperasional({ ...operasional, maxHariPinjamInventaris: e.target.value })} />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Input id="max-tanpa-nota" type="number" step="5000" className="w-40" value={operasional.maxPengeluaranTanpaNota} onChange={(e) => setOperasional({ ...operasional, maxPengeluaranTanpaNota: e.target.value })} />
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-3 border-t border-border/50 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch checked={operasional.wajibPersetujuanKetua} onCheckedChange={(val) => setOperasional({ ...operasional, wajibPersetujuanKetua: val })} />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch checked={operasional.notifPengeluaranBesar} onCheckedChange={(val) => setOperasional({ ...operasional, notifPengeluaranBesar: val })} />
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex justify-end border-t border-border/50 pt-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-1.5 max-w-md">
                  ...
                  <Select value={keamanan.modePendaftaran} onValueChange={(val) => setKeamanan({ ...keamanan, modePendaftaran: val })}>
                  ...
                  <p className="text-[11px] text-muted-foreground">Metode &apos;Hanya Melalui Undangan&apos; paling direkomendasikan untuk menjaga kerahasiaan catatan internal.</p>
                </div>
                ...
                <div className="space-y-1.5 max-w-xs">
                  ...
                  <Select value={keamanan.sessionTimeoutMinutes} onValueChange={(val) => setKeamanan({ ...keamanan, sessionTimeoutMinutes: val })}>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={keamanan.portalPublikAktif} onCheckedChange={(val) => setKeamanan({ ...keamanan, portalPublikAktif: val })} />
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border/50">
                  ...
                  <Switch checked={keamanan.transparansiKasPublik} onCheckedChange={(val) => setKeamanan({ ...keamanan, transparansiKasPublik: val })} />
                </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border/50">
                  ...
                  <Switch checked={keamanan.modeMaintenance} onCheckedChange={(val) => setKeamanan({ ...keamanan, modeMaintenance: val })} />
                </div>
              </CardContent>
              <CardFooter className="flex justify-end border-t border-border/50 pt-4">
        ...
        <TabsContent value="data" className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-3 bg-muted/40 rounded-lg border border-border/50 space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-sm text-emerald-400">{initialStats?.isConnected ? 'Supabase Connected' : 'Online / Connected'}</span>
                  </div>
                ...
                <div className="p-3 bg-muted/40 rounded-lg border border-border/50 space-y-1">
                  ...
                  <div className="font-semibold text-sm text-foreground">{(initialStats?.totalAnggota || 0) + (initialStats?.totalKeuangan || 0) + (initialStats?.totalInventaris || 0) + (initialStats?.totalArsip || 0)} Entitas Data</div>
            ...
            <CardContent className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="p-3.5 border rounded-lg flex flex-col justify-between gap-3 bg-card/60">
                  ...
                  <Button variant="outline" size="sm" className="w-full gap-1.5 text-xs" disabled={isExporting === 'anggota'} onClick={() => handleExportData('anggota')}>
                ...
                <div className="p-3.5 border rounded-lg flex flex-col justify-between gap-3 bg-card/60">
                  ...
                  <Button variant="outline" size="sm" className="w-full gap-1.5 text-xs" disabled={isExporting === 'keuangan'} onClick={() => handleExportData('keuangan')}>
                ...
                <div className="p-3.5 border rounded-lg flex flex-col justify-between gap-3 bg-card/60">
                  ...
                  <Button variant="outline" size="sm" className="w-full gap-1.5 text-xs" disabled={isExporting === 'inventaris'} onClick={() => handleExportData('inventaris')}>
          ...
          <Card>
            <CardHeader className="pb-3 flex flex-row items-center justify-between space-y-0">
              ...
              <Button variant="ghost" size="sm" onClick={handleRefreshLogs} disabled={isRefreshingLogs} className="h-8 gap-1 text-xs text-muted-foreground hover:text-foreground">
          ...
          <Card className="border-destructive/30 bg-destructive/5">
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 bg-background/80 rounded-lg border border-destructive/20">
                ...
                <Button variant="outline" size="sm" onClick={() => setIsResetDialogOpen(true)} className="shrink-0 gap-1.5 text-xs text-destructive border-destructive/30 hover:bg-destructive/10">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 bg-destructive/10 rounded-lg border border-destructive/30">
                ...
                <Button variant="destructive" size="sm" onClick={() => setIsClearDummyDialogOpen(true)} className="shrink-0 gap-1.5 text-xs bg-red-600 hover:bg-red-700 text-white font-medium shadow-sm">
                  <Trash2 className="h-3.5 w-3.5" />
                  Hapus Data Dummy
                </Button>
              </div>
        ...
        <DialogContent className="sm:max-w-[440px] w-[95vw] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="space-y-2 text-xs leading-relaxed">
              ...
              <span className="block font-medium text-foreground pt-1">Akun pengguna resmi Anda di Manajemen Pengguna dan struktur organisasi tetap aman dan dipertahankan.</span>
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="pt-3 gap-2">
            ...
            <Button variant="destructive" onClick={handleConfirmClearDummy} disabled={isClearingDummy} className="bg-red-600 hover:bg-red-700 text-white gap-1.5 font-medium">
